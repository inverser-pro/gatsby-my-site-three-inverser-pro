---
title: "Видео+код: #2/7. Shaders в Three.JS"
short_to_menu: "#2-7 Планета (7 урок)|Shaders"
date: 2022-02-08 01:11:11
description: Из данного урока Вы сможете узнать, как создать анимированный шейдер в Three JS
published: true
category: article
artPre: "/_img/2022/artPre/8-shader"
---

# Видео: 9. Создаём Shaders в Three JS
урок 9 по Three JS / урок 7 по планете

<span className="loadYoutube" data-id="SDA2WmLev2o"></span>
...
<a rel="nofollow noopener" target="_blank" href="https://codepen.io/prisoner849/pen/BaQzqqx" title="Ссылочка на оригинал «бум»">Ссылочка на оригинал «бум»</a>

<br/><br/><a rel="nofollow noopener" target="_blank" href="https://discourse.threejs.org/t/webgl-glsl-shader-one-wave-over-the-sphere/23176" title="Форум по threejs">Форум по threejs (мой вопрос)</a>

<br/><br/><a rel="nofollow noopener" target="_blank" href="https://webglfundamentals.org/webgl/lessons/ru/webgl-how-it-works.html" title="Как работает WebGL">Как работает WebGL</a>

<br/><br/><a rel="nofollow noopener" target="_blank" href="https://webglfundamentals.org/webgl/lessons/webgl-shaders-and-glsl.html" title="WebGL Shaders and GLSL">WebGL Shaders and GLSL</a>

<br/><br/><a rel="nofollow noopener" target="_blank" href="https://www.khronos.org/webgl/wiki/WebGL_and_OpenGL_Differences" title="WebGL and OpenGL Differences">WebGL and OpenGL Differences (как бы сайт создателей технологии WebGL)</a>

### Код из видео (!на **threejs-webpack-starter**!)
<small>В код я добавил два шейдерных матрериала, чтобы Вы могли их поклацать. Оба они эмитируют атмосферу планеты</small>

```javascript{13-15,65-124,463-491,646-689,723}
...
//MOON — 2-й вариант свечения планеты (атмосфера)
...
moonGlow.rotation.y=-8.0;
moonGlow.rotation.x=.9;
//scene.add( moonGlow );
...
<img src="/_img/2022/2-7-shaders-ios.jpg" alt="Баг шейдера на iphone"/>
