...
<span className="loadYoutube" data-id="MKAigaqJiOI"></span>
...
Запускаем наш код командой
`canvas-sketch sketch`
*если Вы имеете в папке другие названия скриптов (например, skethc.js, sketch2.js), то указывается название файла для запуска (можно без расширения .js)
