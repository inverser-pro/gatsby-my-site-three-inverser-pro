---
title: "Видео+код: #2/8. Готовим финал планеты в Three.JS"
short_to_menu: "#2-8 Планета (8 урок)|Рефакторинг"
date: 2022-02-08 23:12:41
description: Готовим финал планеты в Three.JS
published: true
category: article
artPre: "/_img/2022/artPre/9-nom-1"
---

# Видео: 10. Подготавливаем код к production Three JS
урок 10 по Three JS / урок 8 по планете

<span className="loadYoutube" data-id="w_DpxIWWBSE"></span>

## Файлы из урока 8 по 3D планете

[02-8-refactoring.zip](/fls/2022/02-8-refactoring.zip "Скачать файл")
