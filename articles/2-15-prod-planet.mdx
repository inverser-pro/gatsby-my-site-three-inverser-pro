---
title: "Видео+код: #2/15 THREEJS подписи к точкам на карте планеты"
short_to_menu: "#2-15 Планета (15 урок)|Prod"
date: 2022-07-11 10:22:10
description: "Видео+код: #2/15 THREEJS production готов"
published: true
category: article
artPre: "/_img/2022/artPre/15-prod"
---

# Видео: 17 THREEJS координаты земли
урок 17 по Three JS / урок 15 по планете

<span className="loadYoutube" data-id="0_EPM8QK2N0"></span>

## Файлы из урока 15 по 3D планете

[2-15-prod-planet.zip](/fls/2022/2-15-prod-planet.zip "Скачать файл")
