---
title: "Видео+код: #2/14 THREEJS градиентный полупрозрачный шейдер+новые данные для формирования карты планеты"
short_to_menu: "#2-14 Планета (14 урок)|To_Prod"
date: 2022-06-07 18:01:10
description: "Видео+код: #2/14 THREEJS готовит production"
published: true
category: article
artPre: "/_img/2022/artPre/14-for-prod"
---

# Видео: 16 THREEJS координаты земли
урок 16 по Three JS / урок 14 по планете

<span className="loadYoutube" data-id="7BQzqRGvVDM"></span>

## Файлы из урока 14 по 3D планете

[2-14-for-prod.zip](/fls/2022/2-14-for-prod.zip "Скачать файл")

<a href="https://github.com/inverser-pro/threejs-webgl-planet-for-production" rel="noreferrer noopener" target="_blank">GitHUB</a>
