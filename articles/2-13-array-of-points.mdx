---
title: "Видео+код: #2/13 THREEJS массив точек: широта, долгота"
short_to_menu: "#2-13 Планета (13 урок)|Массив"
date: 2022-05-05 21:01:10
description: "Видео+код: #2/13 THREEJS массив точек: широта, долгота"
published: true
category: article
artPre: "/_img/2022/artPre/13-array-of-points"
---

# Видео: 15 THREEJS координаты земли
урок 15 по Three JS / урок 13 по планете

<span className="loadYoutube" data-id="wd31kd65r1E"></span>

## Файлы из урока 13 по 3D планете

[2-13-array-of-points.zip](/fls/2022/2-13-array-of-points.zip "Скачать файл")
