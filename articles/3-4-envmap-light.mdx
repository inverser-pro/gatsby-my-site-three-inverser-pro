---
title: "Видео+код: #3/4 Three.JS envMap, Volumetric light (луч света)"
short_to_menu: "#3-4 Mando|envMap, Volumetric light"
date: 2023-04-20 19:57:50
description: "Видео+код: #3/4 envMap, Volumetric light"
published: true
category: article
artPre: "/_img/2023/3-4"
---

# Видео: #3/4 Three.JS envMap, Volumetric light (луч света)

<span className="loadYoutube" data-id="WmCn8ivN0rY"></span>

## Файлы из урока 3/4 по Mando

[3-4-envmap.7z](/fls/2023/3-4-envmap.7z "Скачать файл [55 MB]")

<a href="https://github.com/inverser-pro/threejs-mandalorian-helmet" rel="noreferrer noopener" target="_blank">GitHUB</a>

<blockquote>Внимание! Могут возникать ошибки в самой 3D модели. Подберите любую другую для теста. Файлы взяты из последнего урока (все файлы присутствуют в архиве. Код — этого урока)</blockquote>
...
```
00:00 Вступление
00:52 Что было прежде?
01:35 Что будет в этом видео?
06:47 Пример использования HDR envMap в ThreeJS
07:57 Сайт с HDR картами без оплаты
08:13 Особенности применения HDR карт
12:54 Применил envMap к шлему Мандалорца
13:55 Поясняю код для HDR карты (envMap)
21:40 Особенность при загрузке карты окружения
23:28 VolumetricSpotLight в ThreeJS
29:20 Код заполняющего света
30:24 Как исправить неочевидные ошибки в коде ThreeJS?
37:36 С чего начинается заполняющий свет?
43:37 Важная особенность добавления объектов на сцену из 3D модели
48:10 Позиционируем и стилизуем цилиндр (заполняющий свет)
1:09:11 Убрал пол, показал конечный результат
1:10:21 Особенности прокрутки в браузере в Linux
1:13:11 Исправление плавности прокрутки сцены из предыдущего урока
1:14:20 Новый bug и устранение прекращения анимирования сцены после 100%
1:17:44 Исправление и пояснение функции scalePercent
1:23:51 Выводы и заключение
1:25:15 Что будет в следующем видео?
1:27:19 До скорых встреч
```
