---
title: "Видео+код: #3/6 ThreeJS Анимация персонажа (запуск двух разных анимаций). Анимирование Мандалорца в Blender 3d"
short_to_menu: "#3-6 Mando|Blender ani + 2 ani на сцене"
date: 2023-09-07 15:57:50
description: "Видео+код: #3/6 ThreeJS Анимация персонажа"
published: true
category: article
artPre: "/_img/2023/3-6"
---

# Видео: #3/6 ThreeJS Анимация персонажа (запуск двух разных анимаций). Анимирование Мандалорца в Blender 3d

<span className="loadYoutube" data-id="-9ptaVKKkf4"></span>

## Файлы из урока 3/6 по Mando

[3-6-jft-2-ani.7z](/fls/2023/3-6-jft-2-ani.7z "Скачать файл [55 MB]")
...
```
00:00-00:24 Каков будет результат урока?
00:24 Особенности 3D модели Мандалорца (Blender)
06:05 Оптимизация модели Мандалорца
07:23 (1) Приступим к коду ThreeJS
08:10 Напоминаю как импортировать GLB модель из Blender для ThreeJS
11:05 ThreeJS AnimationMixer — включаем анимации 3D модели на сцене WEBGL
15:52 ThreeJS управление скоростью анимации 3D модели
19:43 (задача) Как заставить анимацию остановиться (запретить цикличность)
23:34 Хак перемотки анимации в начало при старте сцены
23:59 (решение — способ) выводим в консоль сам 'mixer'
28:04 Решение (код), как остановить цикличность анимации
29:21 Итоги по коду сцены
33:48 Особенности подключения карты окружения (envMap) к модели
43:17 (2) Blender: особенности анимации персонажа, создание скелета
46:03 Особенности «веса» при создании скелета
50:36 Решил сначала показать код, а затем Blender'ить
51:27 Автоматическая генерация скелета персонажа
55:22 Добавление дополнительных костей для персонажа
59:20 Привязка скелета к персонажу в Blender
1:01:07 Особенности распределения автоматически добавленного «веса»
1:07:16 Особенности анимации конкретной кости в Blender
1:16:28 Особенности перехода от одной анимации к другой в ThreeJS (Blender)
1:20:23 Окружение персонажа на сцене ThreeJS (поля, горы) — карта для сферы
1:29:30 Смотрите другие видео. До встречи!
```