---
title: "Видео+код: #3/7 ThreeJS перенос анимации Мандалорца на основную сцену"
short_to_menu: "#3-7 Mando|Mado Full ani"
date: 2023-11-06 20:01:30
description: "Видео+код: #3/7 ThreeJS перенос анимации"
published: true
category: article
artPre: "/_img/2023/3-7"
---

# Видео: #3/7 ThreeJS перенос анимации Мандалорца на основную сцену

<span className="loadYoutube" data-id="CHYm-AXPZwo"></span>

## Файлы из урока 3/7 по Mando

[3-7-ani-to-prod.7z](/fls/2023/3-7-ani-to-prod.7z "Скачать файл [55 MB]")
...
```
00:00 Вступление
00:59 Что я достингу в этом уроке?
01:39 Результат урока
02:00 Приступаем к переносу кода
13:17 Создаю кнопку и обработку JS+HTML+CSS
19:31 Анимация камеры при нажатии мыши (ThreeJS)
24:44 Удаление объектов со сцены ThreeJS
31:41 Переношу сцену из предыдущего урока (тестовой версии) на production версию
34:36 Кеширую полную модель Мандалорца (GLB)
42:38 Запуск AnimationMixer в ThreeJS
44:17 Позиционирование вновь добавленной модели Мандо
48:31 Пробую устранить плохое освещение сцены
55:12 Туман в ThreeJS (Fog)
1:10:45 Разница анимации Blender и animejs
1:15:29 Позиционирование шлема во время анимирования подъёма
1:20:50 Синхронизация двух анимаций (Blender'a и animejs)
1:23:20 Анимирование шлема после хода Мандо
1:27:48 По'Blender'им — попытка создания космического корабля
1:36:20 Попытка добавить космический корабль на сцену ThreeJS
1:39:21 Зачем проходиться циклом по массиву объектов GLB модели (особенности добавления 3D объектов на сцену ThreeJS)
1:40:49 Пробую поменять освещение сцены
1:43:58 Меняем цвет материала по событию...
1:57:13 Разница освещения 3D модели в зависимости от версии ThreeJS
2:04:23 Попытка добавить окружение (скалы) для 3D модели ThreeJS
2:06:55 Добавим корабль Мандалорца на сцену
2:11:12 Пытаюсь настроить туман и его анимацию
2:12:45 Возвращаем шлем из любого положения в изначальное для анимации ходьбы Мандо
2:17:22 До новых встреч
```