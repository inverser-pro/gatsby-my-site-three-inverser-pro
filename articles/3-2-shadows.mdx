---
title: "Видео+код: #3/2 ThreeJS тени, пол, HTML + JS, эффекты при прокрутке страницы"
short_to_menu: "#3-2 Mando|Тени, пол.."
date: 2022-12-26 18:30:15
description: "Видео+код: #3/2 ThreeJS тени, пол, HTML + JS"
published: true
category: article
artPre: "/_img/2023/3-2"
---

# Видео: #3/2 ThreeJS тени, пол, HTML + JS, эффекты при прокрутке страницы

<span className="loadYoutube" data-id="SKQW1nFEZk4"></span>

## Файлы из урока 3/2 по Mando

[3-2-Mando_shadows.7z](/fls/2023/3-2-Mando_shadows.7z "Скачать файл")
