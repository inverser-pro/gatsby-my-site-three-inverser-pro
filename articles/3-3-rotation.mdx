---
title: "Видео+код: #3/3 Three.JS вращение объектов при прокрутке страницы"
short_to_menu: "#3-3 Mando|Вращение"
date: 2023-02-27 09:11:50
description: "Видео+код: #3/3 вращение"
published: true
category: article
artPre: "/_img/2023/3-3"
---

# Видео: #3/3 Three.JS вращение объектов при прокрутке страницы

<span className="loadYoutube" data-id="QQnQfNXHdUs"></span>

## Файлы из урока 3/3 по Mando

[3-3-rotation.7z](/fls/2023/3-3-rotation.7z "Скачать файл [55 MB]")
...
```
00:00 Здравствуйте!
00:58 Где брать исходный код?
01:32 Как скопировать код с github и повторять за мной?
03:22 Что было на предыдущей сцене?
04:08 Blender — он нужен, учите его
05:17 Начинаю пояснять код урока
06:52 Применяем новые свойства материала для загружаемой GLB 3D модели
10:56 Что имеется в GLB 3D модели, вообще?
11:27 Пытаюсь посмотреть, что за объекты у меня в GLB лежат, в Blender
13:16 Пробую понять какие названия объектов относятся к каким объектам на сцене (визуально)
15:19 Добавлю ещё один источник света на сцену Three.JS
17:37 Разные материалы для разных элементов 3D объекта на сцене
20:27 Добавил animejs (ради примера)
21:57 Добавил новый код
23:20 Как именно работает анимация по скроллу мыши?
27:30 Как правильно анимировать объект?
30:52 Специальный коэффициент
33:27 Выводы, что дальше?
33:51 До скорых встреч
```
