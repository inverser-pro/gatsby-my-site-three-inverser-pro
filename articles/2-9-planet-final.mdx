---
title: "Видео+код: #2/9. Планета на Three.JS готова"
short_to_menu: "#2-9 Планета (9 урок)|Готова"
date: 2022-02-08 23:41:51
description: Финал планеты в Three.JS
published: true
category: article
artPre: "/_img/2022/artPre/10-final"
---

# Видео: 11. Планета на Three.JS готова
урок 11 по Three JS / урок 9 по планете

<span className="loadYoutube" data-id="ZqCKI2OwLMI"></span>

## Файлы из урока 9 по 3D планете

[02-9-planet-final.zip](/fls/2022/02-9-planet-final.zip "Скачать файл")
...
<video src="/_video/2022/10-this-is-the-way.mp4" controls playsinline preload="metadata"></video>
...
**«Паук»**, о котором говорил в видео... Код можно добавить в любое место, в области видимости функции createMeshLine

```javascript
//SPIDER | Функция, создающая кривые по которым летят белые линии
...
```
00:00 Cześć przyjacielu
00:08 Refactoring + добавление кода из prod планеты
01:00 Анимация вращения планеты
02:12 Пробую анимировать вращение через animejs
05:49 Поясняю код пред-production
08:35 Стили не бесили
09:00 Что дальше?
10:09 controls.enableDamping — инерция при вращении сцены ThreeJS
11:18 controls.dampingFactor
12:46 controls.minPolarAngle, minAzimutAngle — делаем вращение сцены только по оси X или Y (куда же без stackoverflow)
18:02 Поясняю процесс создания всей анимации на сцене
21:15 «Паук»
22:04 enableDamping немного «криво» выполняется
22:26 Do zobaczenia
```